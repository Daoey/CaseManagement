...
public class TestSqlWorkItemRepository {
	...
	WorkItem workItem3;
	WorkItem workItem4;
	WorkItem workItemWithoutUser1;
	WorkItem workItemWithoutUser2;
	WorkItem workItemWithoutUser3;
	WorkItem workItemWithoutUser4;
	String description1 = "Clean room A1";
	String description2 = "Clean room B2";
	String description3 = "Clean room C3";
	String description4 = "Clean room D4";
	int userId1 = 2;
	int userId2 = 4;
	int userId3 = 6;
	int userId4 = 8;
	...
	public void testSetUp() {
		...
		workItem1 = WorkItem.builder().setDescription(description1)
				.setStatus(WorkItem.Status.STARTED)
				.setUserId(userId1)
				.build();
		workItem2 = WorkItem.builder().setDescription(description2)
				.setStatus(WorkItem.Status.STARTED)
				.setUserId(userId2)
				.build();
		workItem3 = WorkItem.builder().setDescription(description3)
				.setStatus(WorkItem.Status.DONE)
				.setUserId(userId3)
				.build();
		workItem4 = WorkItem.builder().setDescription(description4)
				.setStatus(WorkItem.Status.UNSTARTED)
				.setUserId(userId4)
				.build();
		
		workItemWithoutUser1 = WorkItem.builder().setDescription("Lava la ropa")
				.setStatus(WorkItem.Status.UNSTARTED)
				.build();
		workItemWithoutUser2 = WorkItem.builder().setDescription("Hace la comida")
				.setStatus(WorkItem.Status.UNSTARTED)
				.build();
